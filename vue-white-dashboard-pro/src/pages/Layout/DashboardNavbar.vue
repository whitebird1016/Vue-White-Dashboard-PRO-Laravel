  ...
  >
    ...
    <div class="ml-auto">
        <a
          ...
          target="_blank"
          rel="noopener"
          class="btn btn-default btn-block btn-round d-lg-inline d-none"
        >
          Documentation
        </a>
        <a
          ...
          target="_blank"
          rel="noopener"
          class="btn btn-primary btn-block btn-round d-lg-inline d-none"
        >
          Buy now
        </a>
    </div> 
    <ul class="navbar-nav" :class="$rtl.isRTL ? 'mr-auto' : ''">
      ...
      >
        ...
        <li class="nav-link">
          <a @click="goToProfile" class="nav-item dropdown-item">Profile</a>
        </li>
