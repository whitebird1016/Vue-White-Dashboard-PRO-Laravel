...
module.exports = {
  base: '/documentation/',
  title: 'Vue White Dashboard PRO Laravel by Creative Tim & UPDIVISION',
  markdown: {
    ...
    ['meta',
      {
        name: "keywords",
        content:
          "creative tim, updivision, html dashboard, vue, vuejs, laravel, json:api, json, api, html css dashboard laravel, vue white dashboard laravel, vue white dashboard laravel pro, vue white dashboard, vue white dashboard pro, white vue admin, vue dashboard, vue dashboard pro, vue admin, web dashboard, bootstrap 4 dashboard laravel, bootstrap 4, css3 dashboard, bootstrap 4 admin laravel, white ui dashboard bootstrap 4 laravel, frontend, responsive bootstrap 4 dashboard, white design, white laravel bootstrap 4 dashboard",
      }],
     ['meta', {
        name: "description",
        content:
      ...
      ['meta',{
        itemprop: "name",
        content:
          "Vue White Dashboard PRO Laravel by Creative Tim & UPDIVISION",
      }],
      ['meta', {
      ...
      ['meta',
      {
        itemprop: "image",
        content:
          "https://s3.amazonaws.com/creativetim_bucket/products/409/original/opt_wdp_vuelaravel_thumbnail.jpg",
      }],
      ['meta',{
        name: "twitter:card",
        content: "product",
      ...
      ['meta', {
        property: "og:url",
        content:
          "https://www.creative-tim.com/live/vue-white-dashboard-pro-laravel",
      }],
      ['meta', {
        property: "og:image",
        content:
